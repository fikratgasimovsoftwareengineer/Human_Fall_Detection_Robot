...
{
    public:
        FaceNetClassifier(facenetLogger gLogger, DataType dtype, const string uffFile, const string engineFile, int batchSize,
        ...
        std::map<std::string, int> featureMatching(cv::Mat &image);
